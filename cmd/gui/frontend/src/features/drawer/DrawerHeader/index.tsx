...
import { DrawerAddImages } from '@/features/drawer/DrawerAddImages';
import { DrawerSelectAll } from '@/features/drawer/DrawerSelectAll';
import { DrawerToggle } from '@/features/drawer/DrawerToggle';
import { DrawerZoom } from '@/features/drawer/DrawerZoom';
import { PreviewSelector } from '@/features/drawer/PreviewSelector';
...
export const DrawerHeader = ({ drawerBleeding, className = '' }: FileListHeaderProps) => {
    ...
    return (
        <div
            ...
            className={`flex items-center pl-0.5 pr-3 gap-1 bg-surface-raised ${className}`}
        >
