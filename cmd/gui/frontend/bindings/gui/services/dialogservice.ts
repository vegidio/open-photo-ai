 ...
 */
export function OpenDirDialog(title: string): $CancellablePromise<string> {
    return $Call.ByID(690693041, title);
}
 ...
 */
export function OpenFileDialog(title: string, filterName: string): $CancellablePromise<types$0.File[]> {
    return $Call.ByID(3411436064, title, filterName).then(($result: any) => {
