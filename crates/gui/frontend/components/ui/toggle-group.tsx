    ...
    return (
        <ToggleGroupPrimitive.Item
            ...
            className={cn(
                ...
                "w-auto min-w-0 shrink-0 px-3 focus-visible:z-10",
                "data-[spacing=0]:rounded-none data-[spacing=0]:shadow-none data-[spacing=0]:first:rounded-l-md data-[spacing=0]:last:rounded-r-md data-[spacing=0]:data-[variant=outline]:border-l-0",
                className,
            )}
            {...props}
        >
